...
class WallaHandler(object):
    ...
    def get_article_pages(self, teams_pages):
        ...
        with open('out.json') as json_file:
            ...
            for team_article_address in data:
                zip_iterator = zip(team_article_address['articles'], [image[2:] for image in team_article_address['images']])
    ...
    def get_full_articles(self, article_urls):
        ...
        scrape_to_file('ArticleSportsWalla', articles_address_str, 'articles.json')
